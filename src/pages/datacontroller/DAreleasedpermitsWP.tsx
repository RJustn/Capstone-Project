import '../Styles/DAreleasedpermitsWP.css'; 
...
interface PersonalInformation {
  ...
  const DataControllerReleasedPermitWP: React.FC = () => {
  ...
  return (
      ...
      <div className="DAcontent">
          ...
          <div className='workpermittable'>
            <p>Work Permit Applications (Released)</p>
                  {/* Search Bar */}
        <input
          type="text"
  ...
  export default DataControllerReleasedPermitWP;