...
const Aforpayment: React.FC = () => {
    ...
    return (
       ...
       <div>
            <h1>Admin For Payment</h1>
        </div>
            <div className="Abutton-container"> {/* Centering container */}
            <a href="/AforpaymentBP" className="Abusinesspermitbutton">
                For Assessment Business Permit
            </a>
            <a href="/AforpaymentWP" className="Aworkpermitbutton">
