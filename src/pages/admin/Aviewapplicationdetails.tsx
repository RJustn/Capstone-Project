...
const AdminViewApplicationDetails: React.FC = () => {
    ...
    useEffect(() => {
        const fetchWorkPermitDetails = async () => {
            ...
            try {
                console.log(id);
                const response = await axios.get(`http://localhost:3000/admin/adminworkpermitdetails/${id}`);
                            ...
                            <div className="modal">
                                ...
                                {!isCommentVisible ? (
                                    <>
                                        ...
                                        <button className="Aactionreject-button" onClick={closeRejectModal}>Cancel</button>
                                    </>
                                ) : (
                                    <>
                                        <h3>Comments</h3>
